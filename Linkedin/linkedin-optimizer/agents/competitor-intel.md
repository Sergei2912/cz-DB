...
**CRITICAL: All browser interactions are READ-ONLY.** Never connect, like, comment, message, follow, or interact with competitor profiles in any way. The LinkedIn Write Guard hook enforces this.
